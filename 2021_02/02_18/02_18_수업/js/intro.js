        ...
        galleryFn: function () {
            ...
            $galleryBtn.each(function(index){
                $(this).on({
                    click:function(){
                        ...
                        // 모달창 컨텐츠 배경이미지
                        $(this).parent().css({backgroundImage:'url(../img/img'+n+'.jpg)'});
                        // $content.css({backgroundImage:'url(../img/img0.jpg)'});
                    }
                })
            });
            ...
            $galleryBtn.on({
                click:function (event) {
                    ...
                    // 클릭한 이미지로 배경이미지 변경
                    var bgImg = $(this).parent().css('background-image');   // 클릭한 대상(a)을 감싸고있는 부모(div)의 css값 변경
                    // 모달창 컨텐츠의 배경이미지 변경
